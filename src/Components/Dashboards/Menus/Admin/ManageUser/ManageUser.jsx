...
const ManageUser = () => {
    ...
    const handleDelete = async (id) => {
        ...
        const res = await fetch(`https://matrimony-server-one.vercel.app/api/biodata/${id}`, {
            method: "DELETE",
        });
    ...
    const handleUpdate = async () => {
        ...
        const res = await fetch(`https://matrimony-server-one.vercel.app/api/biodata/${editUser._id}`, {
            method: "PUT",
