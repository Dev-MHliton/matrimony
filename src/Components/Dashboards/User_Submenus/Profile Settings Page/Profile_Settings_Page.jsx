...
const Profile_Settings_Page = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://matrimony-server-one.vercel.app/api/user?email=${user.email}`)
            .then(res => res.json())
            .then(data => {
                setProfile({
                    name: data?.name || "",
    ...
    const handleSubmit = async (e) => {
        ...
        await fetch("https://matrimony-server-one.vercel.app/api/user", {
            method: "PUT",
            headers: {
...
export default Profile_Settings_Page;